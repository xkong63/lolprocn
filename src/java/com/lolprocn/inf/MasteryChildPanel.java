...
public class MasteryChildPanel implements Serializable {
     ...
     */
    private final String PATH = "./resources/images/bundle/4.15.1/img/mastery/";
    private String[][] field1_masteryVal;
    private String[][] field2_masteryVal;
    private String[][] field3_masteryVal;
    private String[][] field1_masteryImgStyle;
    private String[][] field2_masteryImgStyle;
    private String[][] field3_masteryImgStyle;
    private final String imgDefaultStyle = "height:35px;width:35px;opacity:0.3;";
    ...
    public MasteryChildPanel() {
        ...
        field1_masteryImgStyle = new String[][]{
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle}};
        field2_masteryImgStyle = new String[][]{
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle}};
        field3_masteryImgStyle = new String[][]{
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
            {imgDefaultStyle, imgDefaultStyle, imgDefaultStyle, imgDefaultStyle},
    ...
    public String[][] getField1_masteryImgStyle() {
        return field1_masteryImgStyle;
    }

    public void setField1_masteryImgStyle(String[][] field1_masteryImgStyle) {
        this.field1_masteryImgStyle = field1_masteryImgStyle;
    }

    public String[][] getField2_masteryImgStyle() {
        return field2_masteryImgStyle;
    }

    public void setField2_masteryImgStyle(String[][] field2_masteryImgStyle) {
        this.field2_masteryImgStyle = field2_masteryImgStyle;
    }

    public String[][] getField3_masteryImgStyle() {
        return field3_masteryImgStyle;
    }

    public void setField3_masteryImgStyle(String[][] field3_masteryImgStyle) {
        this.field3_masteryImgStyle = field3_masteryImgStyle;
    }
